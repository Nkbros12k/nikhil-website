...
const experiences = [
  {
    ...
    location: "Austin, TX",
    points: [
      "Designed and shipped a full-stack AI product solo where expert AI personas debate a topic, surface disagreements, cite web-searched sources, and output a structured briefing",
      "Built the backend on Bun + Express with Server-Sent Events streaming for a multi-persona debate pipeline using Gemini 2.5 with Google Search grounding",
      "Deployed on Vercel + Render with a keep-warm action, spend guard, and CI running build, dependency audit, and secret scanning",
      "Placed top 20 at Claude Hackathon 2026; live at tryperspect.com",
    ],
    color: "#D2AB67",
  },
  {
    role: "Tech Lead, Drone Road-Inspection Research",
    company: "SBI x UT Austin",
    period: "May 2026 to Present",
    location: "Austin, TX",
    points: [
      "Lead the technical side of a ~10 person research team using drone imagery and computer vision to detect road cracks and stitch them into one georeferenced road map",
      "Built an end-to-end proof of concept in days: a Python pipeline slicing road-test video into ~785 road-cropped frames, then trained a YOLOv11 crack-detection model locally on GPU at zero cloud cost",
      "Diagnosed a camera-angle domain gap between forward-facing and top-down nadir capture that redirected the team data-collection strategy",
      "Authored the research brief setting technical direction across detection and stitching, then split the team into sub-teams",
    ],
    color: "#665DCD",
  },
  {
    ...
    location: "Remote",
    points: [
      "Built and documented the V1 self-hosted object storage on MinIO in Docker with tiered quotas, 365-day lifecycle expiration, and incremental restic snapshots to Backblaze B2",
      "Wrote a POSIX shell disk-monitoring script with four-tier thresholds that logs timestamped events and blocks writes before disk exhaustion",
      "Built three MCP tools that let a multi-agent AI orchestrator generate valid JSON schemas and call the REST API from natural-language prompts",
      "Analyzed the storage platform migration from a single-file prototype to a two-module Clean Architecture system, documenting 12 enterprise design patterns including AES-256-GCM credential vaulting",
      "Contributed to StorageStudio, an open-source React UI for S3-compatible storage, owning backend API design",
    ],
    color: "#5FA4E6",
  },
  {
    role: "Tech Lead",
    company: "HC4A AI with All Hackathon",
    period: "Jul 2026 to Present",
    location: "Austin, TX",
    points: [
      "Co-lead technology and student-council operations for a hackathon targeting ~600 participants in grades 8 to 12",
      "Own participant app feature definition and wireframing on a one-month build timeline",
      "Designed the participant onboarding and validation flow, including a privacy-aware per-participant UID scheme",
      "Lead the technical subgroup on data privacy, security, and portability under COPPA and FERPA constraints",
    ],
    color: "#D2AB67",
  },
  {
    role: "ESG Consulting Intern",
    company: "ICELIS Global",
    period: "Jun 2026 to Jul 2026",
    location: "Doha, Qatar (Remote)",
    points: [
      "Produced comparative analysis of IFRS S1 and S2 sustainability disclosure standards plus a full GCC regulatory scan covering QFMA, ADX, CBB, and FSA",
      "Built two client training modules totaling ~90 slides on standards landscape and materiality assessment methodology",
      "Delivered an internship recap to leadership with four strategic proposals, including an AI agent for first-touch client scoping",
      "Received a letter of recommendation from the Founder and CEO, with a winter return contract extended",
    ],
    color: "#665DCD",
  },
  {
